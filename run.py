...
#def enroll():
 #   form = EnrollmentForm()
  #  if form.validate_on_submit():
   #     flash(f'{form.name.data} has been enrolled!', 'success')
...
def advisor():
    ...
    if form.validate_on_submit():
        ...
        #final_test=form.finaltest._value()
        ...
        if average>=80 and average<=90:
            advice="Your Grades are really good but you still need to study!, We recommend you studying for 30 minutes everyday"
        elif average>=70 and average<80:
            advice="Since your grades are good, they can be improved even more!, We recommend you studying for an hour everyday"
        elif average<70:
            advice="Since your Grades aren't satisfactory, We recommend you studying for 2 hours everyday"
        elif average>90:
            advice="Keep up the brilint work!, you don't need an advice, GO PLAY GAMES"

        #print(advise)
        #print("free time: ",freetime1,freetime2)
        ...
        return redirect(url_for('advising'))
            #else:
                #flash('Roll Number entered was not found', 'danger')
...
def displayfalltest():
    ...
    #fallmarksstr = [str(marks) for marks in fallmarks]
